...
(function () {
  var data = {
    ...
    geo: [
      { name: "Centro de Convenções de Pernambuco", dist: { pt: "4 km", en: "4 km", es: "4 km" }, img: "assets/geo/olinda-aerea.jpg" },
      { name: "Aeroporto Internacional dos Guararapes", dist: { pt: "17 km", en: "17 km", es: "17 km" }, img: "assets/geo/recife-mirante.jpg" },
      { name: "Marco Zero / Recife Antigo", dist: { pt: "8 km", en: "8 km", es: "8 km" }, img: "assets/geo/recife-mirante.jpg" },
      { name: "Praia de Boa Viagem", dist: { pt: "16 km", en: "16 km", es: "16 km" }, img: "assets/hero/era-5-hoje.jpg" },
      { name: "Fernando de Noronha", dist: { pt: "1h de voo", en: "1h flight", es: "1h de vuelo" }, img: "assets/geo/azulejos.webp" }
    ],
    ...
    i18n: {
      pt: {
        ...
        doing: { tag: "Fazer", title: "O que viver em Olinda", sub: "Experiências e lugares selecionados para enriquecer o roteiro.", exp: "Experiências", places: "Lugares para visitar", featured: "Destaque", historic: "Igrejas e monumentos" },
      ...
      en: {
        ...
        doing: { tag: "Do", title: "What to live in Olinda", sub: "Selected experiences and places to enrich the itinerary.", exp: "Experiences", places: "Places to visit", featured: "Featured", historic: "Churches & monuments" },
      ...
      es: {
        ...
        doing: { tag: "Hacer", title: "Qué vivir en Olinda", sub: "Experiencias y lugares seleccionados para enriquecer el itinerario.", exp: "Experiencias", places: "Lugares para visitar", featured: "Destacado", historic: "Iglesias y monumentos" },
