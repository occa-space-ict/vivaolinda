...
(function () {
  var data = {
    ...
    /* ---------- 15 RESTAURANTES (coordenadas geocodificadas via OpenStreetMap Nominatim) ---------- */
    restaurants: [
      { name: "Oficina do Sabor", tel: "+55 81 0000-0000", link: "#", lat: -8.0143068, lng: -34.8529555,
        desc: { pt: "Cozinha pernambucana autoral do chef César Santos, aberta desde 1992 — famosa pelas jericas.", en: "Chef César Santos' signature Pernambuco cuisine since 1992 — famous for its pumpkin 'jericas'.", es: "Cocina pernambucana de autor del chef César Santos desde 1992 — famosa por sus 'jericas'." } },
      { name: "Beijupirá Olinda", tel: "+55 81 0000-0000", link: "#", lat: -8.0117135, lng: -34.8536153,
        desc: { pt: "Frutos do mar criativos no Alto da Sé, com vista panorâmica e toque afro-pernambucano.", en: "Creative seafood at Alto da Sé, with panoramic views and an Afro-Pernambuco touch.", es: "Mariscos creativos en el Alto da Sé, con vista panorámica y toque afro-pernambucano." } },
      { name: "Trattoria Dom Francesco", tel: "+55 81 0000-0000", link: "#", lat: -8.0153174, lng: -34.8520010,
        desc: { pt: "Massas artesanais e tradição italiana na Rua Prudente de Morais.", en: "Handmade pasta and Italian tradition on Rua Prudente de Morais.", es: "Pastas artesanales y tradición italiana en la Rua Prudente de Morais." } },
      { name: "Bistrô Flor do Coco", tel: "+55 81 0000-0000", link: "#", lat: -8.0141500, lng: -34.8529200,
        desc: { pt: "Cozinha franco-brasileira no jardim da Pousada do Amparo, com vista para o Recife.", en: "Franco-Brazilian cuisine in the garden of Pousada do Amparo, with views of Recife.", es: "Cocina franco-brasileña en el jardín de la Pousada do Amparo, con vista a Recife." } },
      { name: "Prudente 242", tel: "+55 81 0000-0000", link: "#", lat: -8.0160346, lng: -34.8513090,
        desc: { pt: "Sabor mineiro autêntico em casarão na Rua Prudente de Morais — só fins de semana.", en: "Authentic Minas Gerais fare in a mansion on Rua Prudente de Morais — weekends only.", es: "Sabor minero auténtico en un caserón de la Rua Prudente de Morais — solo fines de semana." } },
      { name: "Restaurante Patuá", tel: "+55 81 0000-0000", link: "#", lat: -8.0154525, lng: -34.8528462,
        desc: { pt: "Cozinha contemporânea e afetiva do chef Alcindo Queiroz, com foco em frutos do mar, na Ribeira.", en: "Chef Alcindo Queiroz's heartfelt contemporary cuisine, seafood-focused, in Ribeira.", es: "Cocina contemporánea y afectiva del chef Alcindo Queiroz, con foco en mariscos, en Ribeira." } },
      { name: "Restaurante Gracinha", tel: "+55 81 0000-0000", link: "#", lat: -8.0174649, lng: -34.8522553,
        desc: { pt: "Restaurante e cachaçaria na Rua de São Bento, com almoço de quarta a domingo.", en: "Restaurant and cachaçaria on Rua de São Bento, serving lunch Wednesday to Sunday.", es: "Restaurante y cachaçaria en la Rua de São Bento, con almuerzo de miércoles a domingo." } },
      { name: "Olinda Art e Grill", tel: "+55 81 0000-0000", link: "#", lat: -8.0136123, lng: -34.8502493,
        desc: { pt: "Grelhados e arte em frente à Igreja da Sé — famoso pela cocada com sorvete de limão.", en: "Grilled fare and art facing the Sé Cathedral — famous for its cocada with lime ice cream.", es: "Parrilla y arte frente a la Iglesia de la Sé — famoso por su cocada con helado de limón." } },
      { name: "Casa de Noca", tel: "+55 81 0000-0000", link: "#", lat: -8.0138477, lng: -34.8518683,
        desc: { pt: "Ambiente simples e a famosa macaxeira com carne de sol e queijo coalho assado.", en: "A simple spot famous for its cassava with sun-dried beef and grilled coalho cheese.", es: "Ambiente sencillo, famoso por su mandioca con carne seca y queso coalho asado." } },
      { name: "Restaurante Moangá", tel: "+55 81 0000-0000", link: "#", lat: -8.0165399, lng: -34.8530590,
        desc: { pt: "Cozinha no fogo de chão — 'fogo, terra e sabor' no bairro do Carmo.", en: "Wood-fire cooking — 'fire, earth and flavor' in the Carmo neighborhood.", es: "Cocina a fuego de leña — 'fuego, tierra y sabor' en el barrio do Carmo." } },
      { name: "Restaurante Barrio Café e Bar", tel: "+55 81 0000-0000", link: "#", lat: -8.0194500, lng: -34.8539644,
        desc: { pt: "Café e bar descontraído no Varadouro, aberto de segunda a sábado.", en: "Relaxed café and bar in Varadouro, open Monday to Saturday.", es: "Café y bar relajado en el Varadouro, abierto de lunes a sábado." } },
      { name: "Bodega de Veio", tel: "+55 81 0000-0000", link: "#", lat: -8.0129228, lng: -34.8532225,
        desc: { pt: "Bar e mercearia icônicos desde 1981, símbolo afetivo de Olinda.", en: "Iconic bar and grocery since 1981, a beloved Olinda landmark.", es: "Bar y tienda icónicos desde 1981, símbolo afectivo de Olinda." } },
      { name: "Bar do Amparo", tel: "+55 81 0000-0000", link: "#", lat: -8.0145302, lng: -34.8531057,
        desc: { pt: "Cachaça e cerveja de produção própria em bar animado no coração do Sítio Histórico.", en: "House-made cachaça and beer at a lively bar in the heart of the Historic Site.", es: "Cachaça y cerveza de producción propia en un bar animado en el corazón del Sitio Histórico." } },
      { name: "Bar do Ró", tel: "+55 81 0000-0000", link: "#", lat: -8.0139000, lng: -34.8531500,
        desc: { pt: "Comida di buteco, chope gelado e frevo no Largo do Amparo, point do Carnaval de Olinda.", en: "Bar food, cold draft beer and frevo at Largo do Amparo, an Olinda Carnival hotspot.", es: "Comida de boliche, chopp helado y frevo en el Largo do Amparo, punto del Carnaval de Olinda." } },
      { name: "Cafeteria Alto da Sé", tel: "+55 81 0000-0000", link: "#", lat: -8.0131274, lng: -34.8511364,
        desc: { pt: "Café com a melhor vista de Olinda, na praça do Alto da Sé.", en: "Coffee with Olinda's best view, right on the Alto da Sé square.", es: "Café con la mejor vista de Olinda, en la plaza del Alto da Sé." } }
    ],
